...
<head>
    ...
    <title>Kotak Masuk - KSC Member</title>
        ...
        <main class="flex-1 flex flex-col min-w-0 overflow-hidden text-left">
            <header
                ...
                <div class="flex items-center gap-2 md:gap-4 text-left">
                    ...
                    <div>
                        <h1 class="text-lg md:text-xl font-bold text-slate-900 leading-tight">Kotak Masuk</h1>
            ...
            <div class="flex-1 overflow-y-auto p-8">
                <div class="max-w-4xl mx-auto space-y-4">
                    <!-- Unread Message -->
                    <div
                        class="bg-white p-4 md:p-6 rounded-3xl border-l-4 border-l-ksc-blue border border-slate-100 shadow-sm flex items-start gap-3 md:gap-5 hover:bg-slate-50/80 transition cursor-pointer group text-left">
                        <div
                            class="h-10 w-10 md:h-12 md:w-12 bg-blue-50 text-ksc-blue rounded-2xl flex items-center justify-center shrink-0">
                            <i data-lucide="megaphone"
                                class="w-5 h-5 md:w-6 md:h-6 group-hover:scale-110 transition"></i>
                        </div>
                        <div class="flex-1 min-w-0">
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-1 mb-1">
                                <h3 class="font-bold text-slate-900 truncate text-sm md:text-base">Jadwal Latihan
                                    Tambahan: Persiapan Championship</h3>
                                <span
                                    class="text-[9px] md:text-[10px] font-bold text-ksc-blue bg-blue-50 px-2 py-0.5 rounded uppercase self-start">BARU</span>
                            </div>
                            <p class="text-xs md:text-sm text-slate-500 line-clamp-2 md:line-clamp-3 leading-relaxed">
                                Halo atlet, sehubungan dengan kompetisi Annual Championship yang semakin dekat, pengurus
                                mengadakan sesi latihan tambahan khusus teknik pembalikan (flip turn)...</p>
                            <span class="text-[9px] md:text-[10px] text-slate-400 mt-2 md:mt-3 block italic">Diterima 2
                                jam yang lalu</span>
                        </div>
                    </div>
                    ...
                    <!-- Read Message 1 -->
                    <div
                        class="bg-white p-4 md:p-6 rounded-3xl border border-slate-100 shadow-sm flex items-start gap-3 md:gap-5 hover:bg-slate-50 transition cursor-pointer group text-left">
                        <div
                            class="h-10 w-10 md:h-12 md:w-12 bg-slate-100 text-slate-400 rounded-2xl flex items-center justify-center shrink-0">
                            <i data-lucide="check-circle" class="w-5 h-5 md:w-6 md:h-6"></i>
                        </div>
                        <div class="flex-1 min-w-0">
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-1 mb-1">
                                <h3 class="font-bold text-slate-900 truncate text-sm md:text-base">Pembayaran Iuran
                                    Februari 2026</h3>
                                <span class="text-[9px] md:text-[10px] text-slate-400 italic">Kemarin, 14:20</span>
                            </div>
                            <p class="text-xs md:text-sm text-slate-500 line-clamp-2 leading-relaxed">Terima kasih,
                                pembayaran iuran bulanan Anda untuk periode Februari telah kami terima dan diverifikasi
                                oleh sistem keuangan KSC.</p>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div
                            class="h-12 w-12 bg-slate-100 text-slate-400 rounded-2xl flex items-center justify-center shrink-0">
                            <i data-lucide="award" class="w-6 h-6"></i>
                        </div>
                        <div class="flex-1 min-w-0">
                            <div class="flex items-center justify-between mb-1">
                                <h3 class="font-bold text-slate-900 truncate">Pendaftaran Lomba Divalidasi</h3>
                                <span class="text-[10px] text-slate-400 mt-1 block">3 Feb 2026</span>
                            </div>
                            <p class="text-sm text-slate-500 line-clamp-2 leading-relaxed">Status pendaftaran Anda untuk
                                event 'Sprint Series' telah disetujui. Silakan cek detail jadwal pada menu pendaftaran
                                lomba.</p>
                        </div>
                    </div>
                    ...
                    <div class="pt-12 text-center text-slate-400">
                        <p class="text-sm font-medium">Menampilkan 3 pesan terakhir</p>
                    </div>
                </div>
            </div>
        </main>
