                            ...
                            <tr class="hover:bg-slate-50 transition">
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <img src="https://ui-avatars.com/api/?name=Nabil&background=eff6ff&color=1e40af"
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <p class="text-[10px] text-slate-500 uppercase font-medium">{{ $pengguna['nama_klub'] }}
                                    </p>
                                </td>
            ...
            <div class="relative bg-white rounded-lg shadow-2xl border border-slate-200">
                ...
                <form
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
                        ...
                        <div>
                            <label class="block mb-2 text-sm font-semibold text-slate-700">Nama Klub</label>
                                ...
                                <select name="uid_role"
                                    ...
                                    @foreach ($roles as $role)
                                        <option value="{{ $role['uid'] }}"
                                            {{ $pengguna['nama_role'] == $pengguna['nama_role'] ? 'selected' : '' }}>
                                            {{ $role['nama_role'] }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="md:col-span-2 flex items-center gap-3 py-2">
                                <input name="is_active" type="checkbox" id="is_active_checkbox_edit_{{ $pengguna['uid'] }}"
                                    class="w-5 h-5 rounded border-slate-500 bg-slate-300 text-ksc-blue focus:ring-ksc-blue transition cursor-pointer">
                                <label for="is_active_checkbox_edit_{{ $pengguna['uid'] }}" class="text-sm text-slate-600 cursor-pointer transition">
                                    Dengan ini meyetujui keaktifan akun ini.
                                </label>
                            </div>
                            <div class="md:col-span-2 flex items-center gap-3 py-2">
                                <input name="checkbox" type="checkbox" id="terms_checkbox_edit_{{ $pengguna['uid'] }}"
                                    class="w-5 h-5 rounded border-slate-500 bg-slate-300 text-ksc-blue focus:ring-ksc-blue transition cursor-pointer">
                                <label for="terms_checkbox_edit_{{ $pengguna['uid'] }}" class="text-sm text-slate-600 cursor-pointer transition">
