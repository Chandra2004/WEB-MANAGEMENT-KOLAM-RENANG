                ...
                <table class="w-full text-left border-collapse">
                    <thead class="bg-slate-50 border-b border-slate-200">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider text-center">Event</th>
                        ...
                        @foreach ($events['data'] as $event)
                            <tr class="hover:bg-slate-50 transition">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <p class="text-sm text-slate-900">{{ \Carbon\Carbon::parse($event['tanggal_event'])->translatedFormat('d M Y') }}</p>
                                    <p class="text-xs text-slate-500">{{ \Carbon\Carbon::parse($event['waktu_event'])->translatedFormat('H:i:s') }}</p>
                                </td>
            ...
            <div class="relative w-full max-w-4xl max-h-full">
                <div class="relative bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden">
                    <div class="flex items-center justify-between p-4 md:p-6 border-b border-slate-100 bg-slate-50/50">
                        ...
                        <button type="button"
                            class="text-slate-400 hover:bg-slate-100 rounded-xl w-9 h-9 flex justify-center items-center"
                    ...
                    <form id="form-edit-event" class="p-6 md:p-8 overflow-y-auto max-h-[75vh]"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="nama_event" id="edit_nama_event"
                                    ...
                                    class="bg-slate-50 border border-slate-300 text-slate-900 text-sm rounded-xl focus:ring-2 focus:ring-blue-500 block w-full p-3.5 outline-none"
                                    required>
                            </div>
                            ...
                            <div class="text-left">
                                ...
                                <select name="uid_kategori" id="edit_uid_kategori"
                                    class="bg-slate-50 border border-slate-300 text-sm rounded-xl block w-full p-3.5 outline-none">
                                    @foreach ($categories as $category)
                                        <option value="{{ $category['uid'] }}"
                            ...
                            <div x-data="{ tipeEdit: `{{ $event['tipe_event'] }}` }" id="edit-tipe-container" class="text-left">
                                <label class="block mb-2 text-sm font-bold text-slate-700 uppercase tracking-wider">Tipe
                                    Event</label>
                                <div class="grid grid-cols-2 gap-3">
                                    <label
                                        class="flex items-center justify-center p-3.5 bg-slate-50 border border-slate-300 rounded-xl cursor-pointer hover:bg-slate-100 transition"
                                        :class="tipeEdit === 'gratis' ? 'ring-2 ring-blue-500 bg-blue-50 border-blue-200' :
                                            ''">
                                        <input type="radio" name="tipe_event" value="gratis" class="hidden"
                                            x-model="tipeEdit" id="edit_tipe_gratis">
                                        <span class="text-xs font-bold uppercase tracking-widest"
                                            :class="tipeEdit === 'gratis' ? 'text-blue-600' : 'text-slate-500'">Gratis</span>
                                    </label>
                                    <label
                                        class="flex items-center justify-center p-3.5 bg-slate-50 border border-slate-300 rounded-xl cursor-pointer hover:bg-slate-100 transition"
                                        :class="tipeEdit === 'berbayar' ? 'ring-2 ring-blue-500 bg-blue-50 border-blue-200' :
                                            ''">
                                        <input type="radio" name="tipe_event" value="berbayar" class="hidden"
                                            x-model="tipeEdit" id="edit_tipe_berbayar">
                                        <span class="text-xs font-bold uppercase tracking-widest"
                                            :class="tipeEdit === 'berbayar' ? 'text-blue-600' : 'text-slate-500'">Berbayar</span>
                                    </label>
                                </div>
                                <div x-show="tipeEdit === 'berbayar'" x-transition class="mt-4">
                                    ...
                                    <div class="relative mb-4">
                                        ...
                                        <input type="number" name="biaya_event" id="edit_biaya_event"
                                            ...
                                            class="bg-white border border-blue-200 text-sm rounded-xl focus:ring-2 focus:ring-blue-500 block w-full p-3.5 pl-12 outline-none shadow-sm">
                                    </div>
                                    ...
                                    <label
                                        ...
                                        Pembayaran</label>
                                    <select name="uid_payment_method"
                                        class="bg-white border border-blue-200 text-sm rounded-xl focus:ring-2 focus:ring-blue-500 block w-full p-3.5 outline-none shadow-sm"
                        ...
                        <div class="text-left">
                            ...
                            <select name="status_event" id="edit_status_event"
                                class="bg-slate-50 border border-slate-300 text-sm rounded-xl block w-full p-3.5 outline-none">
                                <option {{ $event['status_event'] === 'berjalan' ? 'selected' : '' }} value="berjalan">
                        ...
                        <div class="md:col-span-2 text-left">
                            ...
                            <div class="bg-slate-50 border border-slate-300 rounded-2xl overflow-hidden shadow-inner">
                                <div id="edit-editor-{{ $event['uid'] }}" class="h-56 bg-white text-left font-sans">
                                    {!! $event['deskripsi'] !!}
                                </div>
                ...
                <div class="flex items-center pt-8 mt-6 border-t border-slate-100 space-x-3 justify-end">
                    ...
                    <button type="submit"
                        class="text-white bg-blue-600 hover:bg-blue-700 font-bold rounded-xl text-sm px-10 py-3 shadow-lg transition-all hover:-translate-y-1">Simpan
                        Perubahan</button>
                </div>
                </form>
            </div>
