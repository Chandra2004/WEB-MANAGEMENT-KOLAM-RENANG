...
@section('dashboard-section')
    <div class="p-4 md:p-8 overflow-y-auto">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            <div>
                <h2 class="text-2xl font-black text-slate-900 leading-tight uppercase tracking-tight">Pusat Laporan & Ekspor
                </h2>
                <p class="text-sm text-slate-500 font-medium">Analisis data pertumbuhan klub dan performa event swimming club
                </p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div
                ...
                <div>
                    <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Total Member Terdaftar
                    </p>
            ...
            <div
                ...
                <div>
                    ...
                    <h4 class="text-2xl font-black text-slate-900 tracking-tighter">12</h4>
                </div>
            </div>
            <div
                class="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-xl shadow-slate-100/50 flex items-center gap-5">
                ...
                <div>
                    <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Tingkat Pertumbuhan</p>
                    <h4 class="text-2xl font-black text-slate-900 tracking-tighter">+18.5%</h4>
                </div>
            </div>
        </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-amber-700 leading-relaxed font-medium">Laporan yang diekspor akan
                                mencakup seluruh data yang telah divalidasi oleh sistem. Data registrasi "Menunggu" tidak
                ...
                <div
                    ...
                    <div class="p-6 md:p-8 flex items-center justify-between border-b border-slate-50 bg-slate-50/50">
                        <div class="flex items-center gap-3">
                            ...
                            <h3 class="text-lg font-black text-slate-900 uppercase tracking-tight">Preview Data Terkini</h3>
                        </div>
                        <span
                                    ...
                                    <tr class="hover:bg-slate-50/80 transition cursor-default">
                                        <td class="px-8 py-6">
                                            <p class="text-xs font-bold text-slate-900">
                                                {{ date('d M Y', strtotime($row['tanggal_registrasi'])) }}</p>
                                            <p class="text-[10px] text-slate-400 font-medium">
                                                {{ date('H:i', strtotime($row['tanggal_registrasi'])) }} WIB</p>
                                        </td>
                                        <td class="px-8 py-6">
                                        ...
                                        <td class="px-8 py-6 text-right">
                                            ...
                                            @endphp
                                            <div class="flex items-center justify-end gap-2 text-{{ $statusColor }}-600">
                                                <div
                                                    class="w-1.5 h-1.5 bg-{{ $statusColor }}-600 rounded-full {{ $row['status'] === 'menunggu' ? 'animate-pulse' : '' }}">
                                                </div>
                                                <span
                                                    class="text-[10px] font-black uppercase tracking-widest">{{ $row['status'] }}</span>
                                            </div>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="4" class="px-8 py-10 text-center">
                                            <p class="text-xs font-bold text-slate-400">Tidak ada data untuk ditampilkan
                                            </p>
                                        </td>
                                    </tr>
                                @endforelse
                    ...
                    <div class="p-8 bg-slate-50/30 mt-auto border-t border-slate-50 flex items-center justify-center">
                        <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest italic">-- Gunakan tombol
