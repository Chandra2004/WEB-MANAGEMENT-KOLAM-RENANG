...
<section class="relative h-[40vh] md:h-[50vh] flex items-center bg-hero-fasilitas bg-cover bg-center">
    <div class="container mx-auto px-6 relative z-10 pt-20">
        <div class="max-w-3xl">
            ...
            <h1 class="text-3xl md:text-6xl font-bold text-white leading-tight mb-6">
                Standar <span class="text-ksc-accent">Internasional</span><br>Untuk Kenyamanan Anda.
            </h1>
    ...
    <div class="container mx-auto px-6 space-y-24">
        ...
        <div class="flex flex-col lg:flex-row items-center gap-16 reveal">
            ...
            <div class="w-full lg:w-1/2">
                ...
                <p class="text-slate-600 text-lg mb-8 leading-relaxed">
                    Kolam berukuran 50 x 25 meter dengan kedalaman standar kompetisi internasional. Dilengkapi dengan sistem filtrasi canggih yang menjamin kualitas air tetap prima setiap saat.
                </p>
        ...
        <div class="flex flex-col lg:flex-row-reverse items-center gap-16 reveal">
            ...
            <div class="w-full lg:w-1/2">
                ...
                <p class="text-slate-600 text-lg mb-8 leading-relaxed">
                    Area khusus untuk pemula dan anak-anak dengan kedalaman yang aman dan air yang hangat. Dirancang untuk menumbuhkan rasa percaya diri anak dalam air.
                </p>
                <div class="grid grid-cols-2 gap-4">
                    <div class="flex items-center gap-3 p-4 bg-white rounded-2xl shadow-sm border border-slate-100">
        ...
        <div class="grid md:grid-cols-3 gap-8 reveal">
            <div class="bg-white p-8 rounded-[2rem] shadow-xl shadow-slate-200/50 border border-slate-50 feature-card">
                ...
                <h3 class="text-xl font-bold text-slate-900 mb-4">Dry Land & Gym</h3>
                <p class="text-slate-500 text-sm leading-relaxed">Area fitness khusus untuk melatih kekuatan otot dan stamina atlet di luar kolam.</p>
            </div>
            <div class="bg-white p-8 rounded-[2rem] shadow-xl shadow-slate-200/50 border border-slate-50 feature-card">
                <div class="w-14 h-14 bg-ksc-light text-ksc-blue rounded-2xl flex items-center justify-center mb-6">
            ...
            <div class="bg-white p-8 rounded-[2rem] shadow-xl shadow-slate-200/50 border border-slate-50 feature-card">
                ...
                <p class="text-slate-500 text-sm leading-relaxed">Ruang ganti yang luas, bersih, dan dilengkapi dengan air panas serta loker keamanan.</p>
            </div>
        </div>
