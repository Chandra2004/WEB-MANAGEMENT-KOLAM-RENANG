...
Router::group([
    ...
    Router::add('POST', '/{uidUser}/dashboard/management-registration/create/process', RegistrationController::class, 'registrationCreateProcess', [[RoleMiddleware::class, []]]);
    Router::add('POST', '/{uidUser}/{uidRegistration}/dashboard/management-registration/edit/process', RegistrationController::class, 'registrationEditProcess', [[RoleMiddleware::class, []]]);
    Router::add('POST', '/{uidUser}/{uidRegistration}/dashboard/management-registration/delete/process', RegistrationController::class, 'registrationDeleteProcess', [[RoleMiddleware::class, []]]);
    ...
    Router::add('POST', '/{uidUser}/dashboard/management-gallery/create/process', GalleryController::class, 'galleryCreateProcess', [[RoleMiddleware::class, []]]);
    Router::add('POST', '/{uidUser}/{uidGallery}/dashboard/management-gallery/edit/process', GalleryController::class, 'galleryEditProcess', [[RoleMiddleware::class, []]]);
    Router::add('POST', '/{uidUser}/{uidGallery}/dashboard/management-gallery/delete/process', GalleryController::class, 'galleryDeleteProcess', [[RoleMiddleware::class, []]]);
    ...
    Router::add('POST', '/{uidUser}/dashboard/management-coach/create/process', CoachController::class, 'coachCreateProcess', [[RoleMiddleware::class, []]]);
    Router::add('POST', '/{uidUser}/{uidCoach}/dashboard/management-coach/edit/process', CoachController::class, 'coachEditProcess', [[RoleMiddleware::class, []]]);
    Router::add('POST', '/{uidUser}/{uidCoach}/dashboard/management-coach/delete/process', CoachController::class, 'coachDeleteProcess', [[RoleMiddleware::class, []]]);

    // MEMBER MANAGEMENT
    Router::add('GET', '/dashboard/management-member', MemberController::class, 'member', [[RoleMiddleware::class, ['admin', 'coach']]]);
    Router::add('POST', '/{uidUser}/dashboard/management-member/create/process', MemberController::class, 'memberCreateProcess', [[RoleMiddleware::class, []]]);
    Router::add('POST', '/{uidUser}/{uidMember}/dashboard/management-member/edit/process', MemberController::class, 'memberEditProcess', [[RoleMiddleware::class, []]]);
    Router::add('POST', '/{uidUser}/{uidMember}/dashboard/management-member/delete/process', MemberController::class, 'memberDeleteProcess', [[RoleMiddleware::class, []]]);

    // NOTIFICATION
    Router::add('GET', '/dashboard/notifications', NotificationController::class, 'notification', [[RoleMiddleware::class, ['admin', 'coach', 'member']]]);
    Router::add('POST', '/{uidUser}/{uidNotification}/dashboard/notifications/edit/process', NotificationController::class, 'notificationEditProcess', [[RoleMiddleware::class, ['admin', 'coach', 'member']]]);
    Router::add('POST', '/{uidUser}/{uidNotification}/dashboard/notifications/delete/process', NotificationController::class, 'notificationDeleteProcess', [[RoleMiddleware::class, ['admin', 'coach', 'member']]]);
